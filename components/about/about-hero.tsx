      ...
      <div className="container-width section-padding">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className={`text-4xl md:text-5xl font-bold text-gray-900 mb-6 transition-all duration-1000 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
            ...
            <span className="gradient-eco bg-clip-text text-transparent"> Since 1998</span>
          </h1>
          ...
          <p className={`text-xl text-gray-600 mb-8 leading-relaxed transition-all duration-1000 delay-200 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
            Planet Net Zero is a leading provider of innovative environmental technology solutions, 
            helping industries worldwide reduce their carbon footprint and achieve sustainable operations 
            through cutting-edge emission control systems and biogas purification technologies.
          </p>
