...
import { ArrowRight, Wind, Recycle, TrendingUp, Zap } from 'lucide-react';
import Link from 'next/link';

export function BiogasProductsHero() {
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <p className={`text-xl text-gray-600 leading-relaxed transition-all duration-1000 delay-400 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
              Complete biogas purification solutions for renewable natural gas production, 
              grid injection, and vehicle fuel applications. Achieve 95%+ methane purity 
              with our proven technologies.
            </p>
            ...
            <div className={`flex flex-col sm:flex-row gap-4 transition-all duration-1000 delay-800 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
              ...
              <Button asChild variant="outline" size="lg">
                <Link href="/applications/cbg-rng">
                  View CBG/RNG Solutions
                </Link>
              </Button>
            </div>
          </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-white font-medium">Pure Biomethane</span>
                    </div>
